...
class CRAFT(nn.Module):
    def __init__(self):
        ...
        # U-Net
        self.upconv1 = DoubleConvolution(in_ch=1024, mid_ch=512, out_ch=256)
        self.upconv2 = DoubleConvolution(in_ch=512, mid_ch=256, out_ch=128)
        self.upconv3 = DoubleConvolution(in_ch=256, mid_ch=128, out_ch=64)
        self.upconv4 = DoubleConvolution(in_ch=128, mid_ch=64, out_ch=32)
